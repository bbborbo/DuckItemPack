...
namespace DuckItemPack.Items
{
    class Beans : ItemBase
    {
        ...
        public override GameObject ItemModel => Main.assetBundle.LoadAsset<GameObject>(Main.modelsPath + "Item/Beans.prefab");

        public override Sprite ItemIcon => Main.assetBundle.LoadAsset<Sprite>(Main.iconsPath + "Item/texIconBeans.png");
